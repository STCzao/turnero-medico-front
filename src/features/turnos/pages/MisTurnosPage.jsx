  ...
  return (
    <PageWrapper>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          <h1 className="text-deep font-black text-3xl tracking-tight">Mis Turnos</h1>
          <p className="text-deep/50 text-sm mt-1">Revisá y gestioná tus turnos médicos</p>
        </div>
        <Link
          to={ROUTES.SOLICITAR_TURNO}
          className="bg-deep text-mint font-bold text-sm px-5 py-2.5 rounded-xl hover:bg-navy transition-colors shrink-0"
        >
          + Solicitar turno
        </Link>
      </div>
